  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        width: '100vw',
        height: '100vh',
        zIndex: -1, // Ensures the animation is behind everything else
        overflow: 'hidden',
        display: 'flex',
        justifyContent: 'center',
        alignItems: 'center',
        backgroundColor: '#006FCD', // Background color to match the theme
      }}>
        <Player
          ...
          loop
          style={{
            width: '120%', // Slightly larger to cover the screen
            height: '120%',
            minWidth: '100vw',
            minHeight: '100vh',
            objectFit: 'cover',
            transform: 'scale(1.2)', // Visual adjustment if needed
          }}
        />
      </div>

      {/* Main page content, positioned above the background */}
